<?php
  ...
  function register_cpt_events() {
    $labels = array( 
      ...
      'name_admin_bar' => _x( 'Подію', 'events'),    //назва в адмін барі (тулбарі)
    );
    $args = array( 
      'labels' => $labels,
      'description' => 'Події',
  ...
  function register_cpt_discussions() {
    ...
    $args = array( 
      ...
      'map_meta_cap' => true,
      'hierarchical' => true,
      'supports' => array( 'title', 'revisions', 'comments' ), // 'author', 'thumbnail', 'editor', 
      //'taxonomies' => array( 'post_tag', 'category' ), 
      'has_archive' => true,
      'rewrite' => true,
      'query_var' => true,
  ...
  function register_cpt_tasks() {
    ...
    $args = array( 
      ...
      'map_meta_cap' => true,
      'hierarchical' => true,
      'supports' => array( 'title', 'thumbnail' ), // 'author', 'comments', 'editor', 'revisions'
      //'taxonomies' => array( 'post_tag', 'category' ), 
      'has_archive' => false,
      'rewrite' => true,
      'query_var' => true,
  ...
  function register_cpt_teams() {
    $labels = array( 
      ...
      'name_admin_bar' => _x( 'Члена команди', 'teams'),    //назва в адмін барі (тулбарі)
    );
    $args = array( 
      'labels' => $labels,
  ...
  function register_cpt_partners() {
    $labels = array( 
      ...
      'name_admin_bar' => _x( 'Партнера', 'partners'),    //назва в адмін барі (тулбарі)
    );
    $args = array( 
      'labels' => $labels,
  ...
  function register_cpt_our_looks() {
    $labels = array( 
      ...
      'name_admin_bar' => _x( 'Наш погляд', 'our_looks'),    //назва в адмін барі (тулбарі)
    );
    $args = array( 
      'labels' => $labels,
  ...
  function register_cpt_advices() {
    $labels = array( 
      ...
      'name_admin_bar' => _x( 'Корисну пораду', 'advices'),    //назва в адмін барі (тулбарі)
    );
    $args = array( 
      'labels' => $labels,
      ...
      'map_meta_cap' => true,
      'hierarchical' => true,
      'supports' => array( 'title' ), // 'author', 'thumbnail', 'revisions', 'comments', 'editor'
      //'taxonomies' => array( 'post_tag', 'category' ), 
      'has_archive' => false,
      'rewrite' => true,
      'query_var' => true,
